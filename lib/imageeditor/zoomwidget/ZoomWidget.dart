...
import 'package:flutter_app/imageeditor/zoomwidget/MultiTouchGestureRecognizer.dart';
...
class _ZoomState extends State<ZoomWidget> with TickerProviderStateMixin {
  double localTop = 0.0;
  ...
  Widget build(BuildContext context) {
    print(auxLeft +.0+ localLeft + centerLeft + scaleLeft);
